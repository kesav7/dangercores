...
<div class="form-column-left">
	...
	<fieldset class="fieldset_frm">
		...
		<div class="form-row">
			...
			<input type="hidden" id="upload_url" value="<?php echo secure_site_url('uploads_manager/bridge_' . $upload_destination . '/profile_image'); ?>" />			<input type="hidden" id="delete_url" value="<?php echo secure_site_url('user/delete_profile_image'); ?>" />
		</div>
	</fieldset>
	<div class="form-row">
		<div id="submit_box">
