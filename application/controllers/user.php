...
class User extends MY_Controller {
	...
	public function self_update()
	{
		...
		if( $this->require_min_level(1) )
		{
			...
			// Role specific form
			$data = array(
				'view_file' => 'user/self_update',
				'role_specific_form'=>  $this->load->view( 'user/self_update/self_update_' . $role, $view_data, TRUE ),
				'upload_destination'=>  $view_data['upload_destination'],
				'user_data'=>  $view_data['user_data'],
	...
	public function login()
	{
		...
		$data = array(
			...
			',
			'view_file' => 'auth/login_form',
			'view_data'=>( isset( $view_data ) ) ? $view_data : ''
		);

		$this->front_template->login_template($data);
