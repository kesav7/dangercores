...
class Register extends MY_Controller {
	...
	public function settings()
	{
		...
		if( $this->require_role('admin') )
		{
			...
			$data_datas = array(
				'view_file' => $this->load->view( 'register/settings', $view_data, TRUE ),
			);
			$data = array(
				
				'view_file' => 'register/settings',
			);
	...
	public function pending_registrations()
	{
		...
		if( $this->require_role('admin,manager') )
		{
			...
			$data_datas = array(
				'view_file' => $this->load->view( 'register/show_pending', $view_data, TRUE )
			);
			$data = array(
				'javascripts' => array(
				...
				'view_file' => 'register/show_pending',
			);
